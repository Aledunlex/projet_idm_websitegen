 ...
 * </p>
 * <ul>
 *   <li>{@link univ.pedago.mm.pedagomm.impl.PersonneImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PersonneImpl extends MinimalEObjectImpl.Container implements Personne {
	...
	protected EClass eStaticClass() {
		return PedagommPackage.Literals.PERSONNE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PedagommPackage.PERSONNE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PedagommPackage.PERSONNE__NAME:
			return getName();
		}
