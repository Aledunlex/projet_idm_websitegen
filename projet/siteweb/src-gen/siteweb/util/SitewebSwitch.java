...
public class SitewebSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SitewebPackage.ENTÊTE: {
			Entête entête = (Entête) theEObject;
			T result = caseEntête(entête);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SitewebPackage.CORPS: {
			Corps corps = (Corps) theEObject;
			T result = caseCorps(corps);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SitewebPackage.SECTION: {
			...
			if (result == null)
				result = caseBloc(section);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SitewebPackage.BLOC: {
		...
		case SitewebPackage.PARAGRAPHE: {
			...
			if (result == null)
				result = caseBloc(paragraphe);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SitewebPackage.ACTION: {
		...
		case SitewebPackage.HYPER_LIEN: {
			HyperLien hyperLien = (HyperLien) theEObject;
			T result = caseHyperLien(hyperLien);
			if (result == null)
				result = caseAction(hyperLien);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SitewebPackage.BOUTTON: {
			Boutton boutton = (Boutton) theEObject;
			T result = caseBoutton(boutton);
			if (result == null)
				result = caseAction(boutton);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Entête</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Entête</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEntête(Entête object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Corps</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Corps</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCorps(Corps object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hyper Lien</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hyper Lien</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHyperLien(HyperLien object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Boutton</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Boutton</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBoutton(Boutton object) {
		return null;
	}
